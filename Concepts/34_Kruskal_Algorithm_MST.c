...
*/
	...
	for (int i = 0; i < n; i++) {
		int v1 = findParent(parent, edge[i][0]); //find parent of src for edge i
		int v2 = findParent(parent, edge[i][1]); // find parent of dest for edge i
		int wt = edge[i][2]; //get weight of edge i
